function [Bbox]=ACCS(x0,y0,z0,a,b,c,T,Dim)
...
%         checkZ=[];
        ...
        while size(box,1)~=T
            ...
            Oz = z0 + step * (x0 *y0 - c * z0);

            %检验碰撞
            if t>aband && (AxisL(p1z,p2z,p1x,p2x,x0)>=z0 && AxisL(p1z,p2z,p1x,p2x,Ox)<=Oz)||(AxisL(p1z,p2z,p1x,p2x,x0)<=z0 && AxisL(p1z,p2z,p1x,p2x,Ox)>=Oz)
